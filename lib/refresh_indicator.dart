...
class RefreshIndicatorState extends State<RefreshIndicator>
  ...
  bool _shouldStart(ScrollNotification notification) {
    ...
    double extentOutside = widget.reverse
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    if (!_isRefreshEnabled) return false;
    if (!widget.notificationPredicate(notification)) return false;
    // debugPrint("RefreshIndicatorState._handleScrollNotification: ${notification.runtimeType} -------------------------->");
    // debugPrint("RefreshIndicatorState._handleScrollNotification: extentBefore = ${notification.metrics.extentBefore}");
    // debugPrint("RefreshIndicatorState._handleScrollNotification: extentAfter = ${notification.metrics.extentAfter}");
    // debugPrint("RefreshIndicatorState._handleScrollNotification: axisDirection = ${notification.metrics.axisDirection}");
    // debugPrint("RefreshIndicatorState._handleScrollNotification: _mode = ${_mode}");
    double extentOutside = widget.reverse
        ? notification.metrics.extentAfter
        : notification.metrics.extentBefore;
    ...
    if (indicatorAtTopNow != _isIndicatorAtTop) {
      ...
      // debugPrint("RefreshIndicatorState._handleScrollNotification: ScrollEndNotification ${_mode}");
      switch (_mode) {
  ...
  bool _handleGlowNotification(OverscrollIndicatorNotification notification) {
    if (!_isRefreshEnabled) return false;
    // debugPrint("RefreshIndicatorState._handleGlowNotification: ${notification.leading}");
  ...
  void _checkDragOffset(double containerExtent) {
    ...
    // debugPrint("RefreshIndicatorState._checkDragOffset: ${newValue}");
    if (_mode == _RefreshIndicatorMode.armed)
      newValue = math.max(newValue, 1.0 / _kDragSizeFactorLimit);
    _positionController.value = newValue.clamp(0.0, 1.0); // this triggers various rebuilds
    // debugPrint("RefreshIndicatorState._checkDragOffset: ${containerExtent}/${_mode}/${_valueColor.value.alpha}");
  ...
  /// Set refresh enabled or not
  void setRefreshEnabled(bool enabled) {
    _isRefreshEnabled = enabled;
  }
